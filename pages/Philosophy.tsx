    ...
    <div className="bg-white">
      <section className="relative h-[60vh] flex items-center justify-center text-white">
        ...
        <div className="relative text-center max-w-4xl px-4 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <h1 className="text-6xl font-serif font-bold mb-6">Our Philosophy</h1>
          <p className="text-2xl font-light text-blue-100 italic">
            "At IUSL Campus, we respect our students and understand that each of
            them has individual wants and needs."
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center mb-24">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                We believe that learning can only be fostered from a feeling of
                mutual respect, guidance, and direction, and we do our very best
                to maintain those values in everything we do. Our unique
                approach supplies our students with the proper support system
          ...
          <div className="grid sm:grid-cols-3 gap-10">
            <div className="p-8 bg-slate-50 rounded-2xl text-center">
              ...
              <p className="text-gray-500">
                Every student is valued for their unique background and
                aspirations.
              </p>
            </div>
            <div className="p-8 bg-slate-50 rounded-2xl text-center">
              ...
              <p className="text-gray-500">
                Mentorship that adapts to the speed and style of the learner.
              </p>
            </div>
            <div className="p-8 bg-slate-50 rounded-2xl text-center">
              ...
              <p className="text-gray-500">
                Focusing on professional skills that matter in the global
                economy.
              </p>
            </div>
          </div>
