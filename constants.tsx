...
export const FACULTIES: Faculty[] = [
  ...
  },
  {
    ...
    imageUrl: 'public/computing.webp',
    icon: 'Code'
  },
  {
    id: 'arts',
  ...
  },
  {
    ...
    longDescription: 'Nurturing Wisdom, Cultivating Compassion The Faculty of Buddhist Studies at the IUSL explores and decimates the teachings of the Buddhist philosophy. Certificate courses in Buddhist studies may be followed online, in addition to the foundation courses which embrace the rich legacy of the religion..',
    courses: ['Buddhist Philosophy', 'Certificate in Buddhist Studies', 'Pali & Sanskrit'],
    imageUrl: 'public/buddhist.webp',
    icon: 'Compass'
  }
];
